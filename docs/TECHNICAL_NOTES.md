...
音量は実機で聞き取りやすいようPulseチャンネルの出力レベルを常に最大15で書き込みます。Amp Decayは音量フェードではなく発音ゲート長として扱い、Amp Attackは将来の音量カーブ用パラメータとしてデータ上は保持します。
...
- APUマスター音量は`NR50=0x77`、パンは`NR51=0x12`
